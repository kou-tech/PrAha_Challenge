...
Table "注文お好みすし" as order_single_meneu {
  "注文お好みすしID" int [pk]
  "注文詳細ID" int
  "お好みすしID" int
}

Table "お好みすし" as single_meneu {
  "お好みすしID" int [pk]
  "税抜き商品金額" int
  "商品名" varchar
  "削除日時" datetime
...
ref: order_detail."注文詳細ID" < order_single_meneu."注文詳細ID"
ref: single_meneu."お好みすしID" < order_single_meneu."お好みすしID"
ref: order_detail."注文詳細ID" < order_set_menu."注文詳細ID"
ref: set_menu."セットメニューID" < order_set_menu."セットメニューID"
ref: single_meneu."お好みすしID" < set_single_menu."お好みすしID"
